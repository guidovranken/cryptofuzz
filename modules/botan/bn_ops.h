...
class Operation {
    public:
        virtual bool Run(Datasource& ds, ::Botan::BigInt& res, std::vector<::Botan::BigInt>& bn, const std::optional<::Botan::BigInt>& modulo) const = 0;
        virtual ~Operation() { }
};

class Add : public Operation {
    public:
        bool Run(Datasource& ds, ::Botan::BigInt& res, std::vector<::Botan::BigInt>& bn, const std::optional<::Botan::BigInt>& modulo) const override;
};
