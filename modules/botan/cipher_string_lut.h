static const std::map<uint64_t, std::string> LUT = {
    ...
    { CF_CIPHER("THREEFISH_512_CBC"), "Threefish_512/CBC" },
    { CF_CIPHER("THREEFISH_512_CTR"), "Threefish_512/CTR" },
    { CF_CIPHER("THREEFISH_512_OFB"), "Threefish_512/OFB" },
    { CF_CIPHER("THREEFISH_512_XTS"), "Threefish_512/XTS" },
