static const std::map<uint64_t, std::pair<std::string, std::string>> LUT = {
    ...
    { CF_CIPHER("KUZNYECHIK_CBC"), {"Kuznyechik/CBC", "Kuznyechik"} },
    { CF_CIPHER("KUZNYECHIK_CFB"), {"Kuznyechik/CFB", "Kuznyechik"} },
    { CF_CIPHER("KUZNYECHIK_CTR"), {"Kuznyechik/CTR", "Kuznyechik"} },
