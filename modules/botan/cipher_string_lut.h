static const std::map<uint64_t, std::string> LUT = {
    ...
    { CF_CIPHER("SERPENT_CBC"), "Serpent/CBC" },
    { CF_CIPHER("SERPENT_CTR"), "Serpent/CTR" },
    { CF_CIPHER("SERPENT_OFB"), "Serpent/OFB" },
    { CF_CIPHER("SERPENT_XTS"), "Serpent/XTS" },
    ...
    { CF_CIPHER("TWOFISH_CBC"), "Twofish/CBC" },
    { CF_CIPHER("TWOFISH_CTR"), "Twofish/CTR" },
    { CF_CIPHER("TWOFISH_OFB"), "Twofish/OFB" },
    { CF_CIPHER("TWOFISH_XTS"), "Twofish/XTS" },
