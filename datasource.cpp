...
template void fuzzing::datasource::Base::Put<uint64_t>(const uint64_t& v, const uint64_t id);
template void fuzzing::datasource::Base::Put<uint32_t>(const uint32_t& v, const uint64_t id);
template void fuzzing::datasource::Base::Put<uint8_t>(const uint8_t& v, const uint64_t id);
